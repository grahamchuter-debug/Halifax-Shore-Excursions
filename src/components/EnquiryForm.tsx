...
function buildMailto(fields: {
  ...
  const subject = `Halifax shore excursion enquiry${
    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-blue-200 bg-blue-50 p-5">
        ...
        <p className="mt-1 text-sm text-blue-900/80">
          Email us to ask about availability for your Halifax port day. This site
          does not take online bookings or confirmations.
        </p>
        <a
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <label className="block">
          ...
          <textarea
            ...
            rows={4}
            className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2"
            placeholder="Group size, mobility needs, all-aboard time, berth if known…"
          />
        </label>
        <button
          type="submit"
